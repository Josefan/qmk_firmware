...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------+--------------------|   |--------------------+--------+--------+--------+--------+--------+--------|
                                          KC_LALT, KC_LGUI,  LT(_LOWER, KC_SPC),    LT(_RAISE, KC_ENT),   KC_RGUI, TG(_LOWER)
  //                                    |--------------------------------------|   |-----------------------------------------|
  ...
  //|--------+--------+--------+--------+--------+--------+--------------------|   |-----+--------+--------+--------+--------+--------+----|
                                          KC_LALT, _LOWER,      KC_SPC,             LT(_ADJUST, KC_ENT),  KC_RGUI,  KC_RALT \
                                      //`--------------------------------------'   `---------------------------------------'
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LCTL, KC_MUTE, KC_MPRV, KC_MNXT, KC_MPLY, KC_VOLU,                      KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT, XP(4,5), XP(2,3),\
   //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT, KC_BRID, KC_BRIU, KC_PGDN, KC_PGUP, KC_VOLD,                      KC_HOME, KC_END,  KC_COMM, KC_DOT,  X(6),    KC_DEL, \
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LALT, KC_LGUI, LOWER,      RAISE,   KC_RGUI, TG(_LOWER)
  //                                    |--------------------------|  |------------------------------|
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LCTL, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                        KC_MINS, KC_EQL,  XXXXXXX, KC_LBRC, KC_RBRC, KC_GRV, \
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,                       KC_F11,  KC_F12,  XXXXXXX, XXXXXXX, KC_BSLS, KC_DEL, \
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LALT, KC_LGUI, LOWER,      RAISE,   KC_RGUI, KC_RALT
  //                                    |--------------------------|  |------------------------------|
  ),
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, UC_LNX,  XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,\
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, UC_WINC,TG(_GAME),                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,\
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LALT, KC_LGUI, XXXXXXX,    XXXXXXX, KC_RGUI, KC_RALT
  //                                    |--------------------------|  |------------------------------|
  )
};
...
// Light no LEDs when default layer is active
const rgblight_segment_t PROGMEM my_default_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {0, 6, HSV_WHITE}
    //{0, 27, HSV_WHITE}
);
// Light LEDs 6 and 13-14 in HSV_MAGENTA when keyboard layer 1 is active
const rgblight_segment_t PROGMEM my_layer1_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {6, 1, HSV_MAGENTA},
    {13, 2, HSV_MAGENTA}
);
// Light LEDs 6 and 13-14 in HSV_CYAN when keyboard layer 2 is active
const rgblight_segment_t PROGMEM my_layer2_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {6, 1, HSV_CYAN},
    {13, 2, HSV_CYAN}
);
// Light LEDs 6 and 13-14 in HSV_ORANGE when keyboard layer 3 is active
const rgblight_segment_t PROGMEM my_layer3_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    {6, 1, HSV_ORANGE},
    {13, 2, HSV_ORANGE}
);
// Light LEDs 6 and 13-14 in HSV_CHARTREUSE when keyboard layer 4 is active
